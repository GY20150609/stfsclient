...
# source: stfsclient/tensorflow/variable.proto
...
VariableDef = _reflection.GeneratedProtocolMessageType('VariableDef', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow.variable_pb2'
