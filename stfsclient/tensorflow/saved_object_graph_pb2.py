...
# source: stfsclient/tensorflow/saved_object_graph.proto
...
from stfsclient.tensorflow import trackable_object_graph_pb2 as stfsclient_dot_tensorflow_dot_trackable__object__graph__pb2
from stfsclient.tensorflow import struct_pb2 as stfsclient_dot_tensorflow_dot_struct__pb2
...
_SAVEDOBJECT.fields_by_name['children'].message_type = stfsclient_dot_tensorflow_dot_trackable__object__graph__pb2._TRACKABLEOBJECTGRAPH_TRACKABLEOBJECT_OBJECTREFERENCE
_SAVEDOBJECT.fields_by_name['slot_variables'].message_type = stfsclient_dot_tensorflow_dot_trackable__object__graph__pb2._TRACKABLEOBJECTGRAPH_TRACKABLEOBJECT_SLOTVARIABLEREFERENCE
...
_SAVEDUSEROBJECT.fields_by_name['version'].message_type = stfsclient_dot_tensorflow_dot_versions__pb2._VERSIONDEF
_SAVEDFUNCTION.fields_by_name['function_spec'].message_type = _FUNCTIONSPEC
_SAVEDCONCRETEFUNCTION.fields_by_name['canonicalized_input_signature'].message_type = stfsclient_dot_tensorflow_dot_struct__pb2._STRUCTUREDVALUE
_SAVEDCONCRETEFUNCTION.fields_by_name['output_signature'].message_type = stfsclient_dot_tensorflow_dot_struct__pb2._STRUCTUREDVALUE
_SAVEDVARIABLE.fields_by_name['dtype'].enum_type = stfsclient_dot_tensorflow_dot_types__pb2._DATATYPE
_SAVEDVARIABLE.fields_by_name['shape'].message_type = stfsclient_dot_tensorflow_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_SAVEDVARIABLE.fields_by_name['synchronization'].enum_type = stfsclient_dot_tensorflow_dot_variable__pb2._VARIABLESYNCHRONIZATION
_SAVEDVARIABLE.fields_by_name['aggregation'].enum_type = stfsclient_dot_tensorflow_dot_variable__pb2._VARIABLEAGGREGATION
_FUNCTIONSPEC.fields_by_name['fullargspec'].message_type = stfsclient_dot_tensorflow_dot_struct__pb2._STRUCTUREDVALUE
_FUNCTIONSPEC.fields_by_name['input_signature'].message_type = stfsclient_dot_tensorflow_dot_struct__pb2._STRUCTUREDVALUE
...
SavedObjectGraph = _reflection.GeneratedProtocolMessageType('SavedObjectGraph', (_message.Message,), {
  ...
  'ConcreteFunctionsEntry' : _reflection.GeneratedProtocolMessageType('ConcreteFunctionsEntry', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow.saved_object_graph_pb2'
