...
# source: stfsclient/tensorflow/cluster.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/cluster.proto',
  package='tensorflow',
  syntax='proto3',
...
JobDef = _reflection.GeneratedProtocolMessageType('JobDef', (_message.Message,), {
  ...
  'TasksEntry' : _reflection.GeneratedProtocolMessageType('TasksEntry', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow.cluster_pb2'
