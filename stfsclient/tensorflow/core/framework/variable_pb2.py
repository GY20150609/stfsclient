...
# source: stfsclient/tensorflow/core/framework/variable.proto
...
VariableDef = _reflection.GeneratedProtocolMessageType('VariableDef', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow.core.framework.variable_pb2'
