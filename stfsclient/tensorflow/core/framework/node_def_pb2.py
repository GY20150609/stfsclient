...
# source: stfsclient/tensorflow/core/framework/node_def.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/core/framework/node_def.proto',
  package='tensorflow',
  syntax='proto3',
...
_NODEDEF_ATTRENTRY.fields_by_name['value'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_attr__value__pb2._ATTRVALUE
...
NodeDef = _reflection.GeneratedProtocolMessageType('NodeDef', (_message.Message,), {
  ...
  'AttrEntry' : _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow.core.framework.node_def_pb2'
