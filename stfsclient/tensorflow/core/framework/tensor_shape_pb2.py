...
# source: stfsclient/tensorflow/core/framework/tensor_shape.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/core/framework/tensor_shape.proto',
  package='tensorflow',
  syntax='proto3',
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), {
  ...
  'Dim' : _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow.core.framework.tensor_shape_pb2'
