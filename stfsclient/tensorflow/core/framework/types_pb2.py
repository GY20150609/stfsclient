...
# source: stfsclient/tensorflow/core/framework/types.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/core/framework/types.proto',
  package='tensorflow',
  syntax='proto3',
