...
# source: stfsclient/tensorflow/core/framework/cost_graph.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/core/framework/cost_graph.proto',
  package='tensorflow',
  syntax='proto3',
...
_COSTGRAPHDEF_NODE_OUTPUTINFO.fields_by_name['shape'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_COSTGRAPHDEF_NODE_OUTPUTINFO.fields_by_name['dtype'].enum_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
...
CostGraphDef = _reflection.GeneratedProtocolMessageType('CostGraphDef', (_message.Message,), {
  ...
  'Node' : _reflection.GeneratedProtocolMessageType('Node', (_message.Message,), {
    ...
    'InputInfo' : _reflection.GeneratedProtocolMessageType('InputInfo', (_message.Message,), {
      ...
      '__module__' : 'stfsclient.tensorflow.core.framework.cost_graph_pb2'
