...
# source: stfsclient/tensorflow/core/framework/attr_value.proto
...
from stfsclient.tensorflow.core.framework import tensor_pb2 as stfsclient_dot_tensorflow_dot_core_dot_framework_dot_tensor__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/core/framework/attr_value.proto',
  package='tensorflow',
  syntax='proto3',
...
_ATTRVALUE_LISTVALUE.fields_by_name['type'].enum_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
_ATTRVALUE_LISTVALUE.fields_by_name['shape'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['tensor'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_tensor__pb2._TENSORPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['func'].message_type = _NAMEATTRLIST
_ATTRVALUE_LISTVALUE.containing_type = _ATTRVALUE
_ATTRVALUE.fields_by_name['type'].enum_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
_ATTRVALUE.fields_by_name['shape'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE.fields_by_name['tensor'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_tensor__pb2._TENSORPROTO
...
AttrValue = _reflection.GeneratedProtocolMessageType('AttrValue', (_message.Message,), {
  ...
  'ListValue' : _reflection.GeneratedProtocolMessageType('ListValue', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow.core.framework.attr_value_pb2'
