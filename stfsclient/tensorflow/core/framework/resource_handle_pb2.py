...
# source: stfsclient/tensorflow/core/framework/resource_handle.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/core/framework/resource_handle.proto',
  package='tensorflow',
  syntax='proto3',
...
_RESOURCEHANDLEPROTO_DTYPEANDSHAPE.fields_by_name['dtype'].enum_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
_RESOURCEHANDLEPROTO_DTYPEANDSHAPE.fields_by_name['shape'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
...
ResourceHandleProto = _reflection.GeneratedProtocolMessageType('ResourceHandleProto', (_message.Message,), {
  ...
  'DtypeAndShape' : _reflection.GeneratedProtocolMessageType('DtypeAndShape', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow.core.framework.resource_handle_pb2'
