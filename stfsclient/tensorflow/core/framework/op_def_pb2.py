...
# source: stfsclient/tensorflow/core/framework/op_def.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/core/framework/op_def.proto',
  package='tensorflow',
  syntax='proto3',
...
_OPDEF_ARGDEF.fields_by_name['type'].enum_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
_OPDEF_ARGDEF.containing_type = _OPDEF
_OPDEF_ATTRDEF.fields_by_name['default_value'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_attr__value__pb2._ATTRVALUE
_OPDEF_ATTRDEF.fields_by_name['allowed_values'].message_type = stfsclient_dot_tensorflow_dot_core_dot_framework_dot_attr__value__pb2._ATTRVALUE
...
OpDef = _reflection.GeneratedProtocolMessageType('OpDef', (_message.Message,), {
  ...
  'ArgDef' : _reflection.GeneratedProtocolMessageType('ArgDef', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow.core.framework.op_def_pb2'
