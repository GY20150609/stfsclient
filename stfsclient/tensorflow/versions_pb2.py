...
# source: stfsclient/tensorflow/versions.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/versions.proto',
  package='tensorflow',
  syntax='proto3',
...
VersionDef = _reflection.GeneratedProtocolMessageType('VersionDef', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow.versions_pb2'
