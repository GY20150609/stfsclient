...
# source: stfsclient/tensorflow/rewriter_config.proto
...
_REWRITERCONFIG_CUSTOMGRAPHOPTIMIZER_PARAMETERMAPENTRY.fields_by_name['value'].message_type = stfsclient_dot_tensorflow_dot_attr__value__pb2._ATTRVALUE
...
_REWRITERCONFIG.fields_by_name['inter_optimizer_verifier_config'].message_type = stfsclient_dot_tensorflow_dot_verifier__config__pb2._VERIFIERCONFIG
_REWRITERCONFIG.fields_by_name['post_optimization_verifier_config'].message_type = stfsclient_dot_tensorflow_dot_verifier__config__pb2._VERIFIERCONFIG
...
AutoParallelOptions = _reflection.GeneratedProtocolMessageType('AutoParallelOptions', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow.rewriter_config_pb2'
