...
# source: stfsclient/tensorflow/saver.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow/saver.proto',
  package='tensorflow',
  syntax='proto3',
...
SaverDef = _reflection.GeneratedProtocolMessageType('SaverDef', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow.saver_pb2'
