...
# source: stfsclient/tensorflow_serving/internal/prediction_log.proto
...
from stfsclient.tensorflow_serving.internal import classification_pb2 as stfsclient_dot_tensorflow__serving_dot_internal_dot_classification__pb2
from stfsclient.tensorflow_serving.internal import inference_pb2 as stfsclient_dot_tensorflow__serving_dot_internal_dot_inference__pb2
from stfsclient.tensorflow_serving.internal import predict_pb2 as stfsclient_dot_tensorflow__serving_dot_internal_dot_predict__pb2
from stfsclient.tensorflow_serving.internal import regression_pb2 as stfsclient_dot_tensorflow__serving_dot_internal_dot_regression__pb2
from stfsclient.tensorflow_serving.internal import session_service_pb2 as stfsclient_dot_tensorflow__serving_dot_internal_dot_session__service__pb2
from stfsclient.tensorflow_serving.internal import logging_pb2 as stfsclient_dot_tensorflow__serving_dot_internal_dot_logging__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow_serving/internal/prediction_log.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n;stfsclient/tensorflow_serving/internal/prediction_log.proto\x12\x12tensorflow.serving\x1a;stfsclient/tensorflow_serving/internal/classification.proto\x1a\x36stfsclient/tensorflow_serving/internal/inference.proto\x1a\x34stfsclient/tensorflow_serving/internal/predict.proto\x1a\x37stfsclient/tensorflow_serving/internal/regression.proto\x1a<stfsclient/tensorflow_serving/internal/session_service.proto\x1a\x34stfsclient/tensorflow_serving/internal/logging.proto\"\x87\x01\n\x0b\x43lassifyLog\x12:\n\x07request\x18\x01 \x01(\x0b\x32).tensorflow.serving.ClassificationRequest\x12<\n\x08response\x18\x02 \x01(\x0b\x32*.tensorflow.serving.ClassificationResponse\"~\n\nRegressLog\x12\x36\n\x07request\x18\x01 \x01(\x0b\x32%.tensorflow.serving.RegressionRequest\x12\x38\n\x08response\x18\x02 \x01(\x0b\x32&.tensorflow.serving.RegressionResponse\"x\n\nPredictLog\x12\x33\n\x07request\x18\x01 \x01(\x0b\x32\".tensorflow.serving.PredictRequest\x12\x35\n\x08response\x18\x02 \x01(\x0b\x32#.tensorflow.serving.PredictResponse\"\x8d\x01\n\x11MultiInferenceLog\x12:\n\x07request\x18\x01 \x01(\x0b\x32).tensorflow.serving.MultiInferenceRequest\x12<\n\x08response\x18\x02 \x01(\x0b\x32*.tensorflow.serving.MultiInferenceResponse\"\x81\x01\n\rSessionRunLog\x12\x36\n\x07request\x18\x01 \x01(\x0b\x32%.tensorflow.serving.SessionRunRequest\x12\x38\n\x08response\x18\x02 \x01(\x0b\x32&.tensorflow.serving.SessionRunResponse\"\xfd\x02\n\rPredictionLog\x12\x35\n\x0clog_metadata\x18\x01 \x01(\x0b\x32\x1f.tensorflow.serving.LogMetadata\x12\x37\n\x0c\x63lassify_log\x18\x02 \x01(\x0b\x32\x1f.tensorflow.serving.ClassifyLogH\x00\x12\x35\n\x0bregress_log\x18\x03 \x01(\x0b\x32\x1e.tensorflow.serving.RegressLogH\x00\x12\x35\n\x0bpredict_log\x18\x06 \x01(\x0b\x32\x1e.tensorflow.serving.PredictLogH\x00\x12\x44\n\x13multi_inference_log\x18\x04 \x01(\x0b\x32%.tensorflow.serving.MultiInferenceLogH\x00\x12<\n\x0fsession_run_log\x18\x05 \x01(\x0b\x32!.tensorflow.serving.SessionRunLogH\x00\x42\n\n\x08log_typeB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[stfsclient_dot_tensorflow__serving_dot_internal_dot_classification__pb2.DESCRIPTOR,stfsclient_dot_tensorflow__serving_dot_internal_dot_inference__pb2.DESCRIPTOR,stfsclient_dot_tensorflow__serving_dot_internal_dot_predict__pb2.DESCRIPTOR,stfsclient_dot_tensorflow__serving_dot_internal_dot_regression__pb2.DESCRIPTOR,stfsclient_dot_tensorflow__serving_dot_internal_dot_session__service__pb2.DESCRIPTOR,stfsclient_dot_tensorflow__serving_dot_internal_dot_logging__pb2.DESCRIPTOR,])
...
_CLASSIFYLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_classification__pb2._CLASSIFICATIONREQUEST
_CLASSIFYLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_classification__pb2._CLASSIFICATIONRESPONSE
_REGRESSLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_regression__pb2._REGRESSIONREQUEST
_REGRESSLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_regression__pb2._REGRESSIONRESPONSE
_PREDICTLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_predict__pb2._PREDICTREQUEST
_PREDICTLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_predict__pb2._PREDICTRESPONSE
_MULTIINFERENCELOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_inference__pb2._MULTIINFERENCEREQUEST
_MULTIINFERENCELOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_inference__pb2._MULTIINFERENCERESPONSE
_SESSIONRUNLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_session__service__pb2._SESSIONRUNREQUEST
_SESSIONRUNLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_session__service__pb2._SESSIONRUNRESPONSE
_PREDICTIONLOG.fields_by_name['log_metadata'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_logging__pb2._LOGMETADATA
...
ClassifyLog = _reflection.GeneratedProtocolMessageType('ClassifyLog', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.internal.prediction_log_pb2'
