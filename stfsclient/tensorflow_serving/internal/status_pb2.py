...
# source: stfsclient/tensorflow_serving/internal/status.proto
...
from stfsclient.tensorflow import error_codes_pb2 as stfsclient_dot_tensorflow_dot_error__codes__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow_serving/internal/status.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n3stfsclient/tensorflow_serving/internal/status.proto\x12\x12tensorflow.serving\x1a\'stfsclient/tensorflow/error_codes.proto\"k\n\x0bStatusProto\x12\x36\n\nerror_code\x18\x01 \x01(\x0e\x32\x16.tensorflow.error.CodeR\nerror_code\x12$\n\rerror_message\x18\x02 \x01(\tR\rerror_messageB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[stfsclient_dot_tensorflow_dot_error__codes__pb2.DESCRIPTOR,])
...
_STATUSPROTO.fields_by_name['error_code'].enum_type = stfsclient_dot_tensorflow_dot_error__codes__pb2._CODE
...
StatusProto = _reflection.GeneratedProtocolMessageType('StatusProto', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.internal.status_pb2'
