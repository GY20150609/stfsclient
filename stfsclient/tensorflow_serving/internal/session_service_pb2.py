...
# source: stfsclient/tensorflow_serving/internal/session_service.proto
...
from stfsclient.tensorflow import config_pb2 as stfsclient_dot_tensorflow_dot_config__pb2
from stfsclient.tensorflow import named_tensor_pb2 as stfsclient_dot_tensorflow_dot_named__tensor__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow_serving/internal/session_service.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n<stfsclient/tensorflow_serving/internal/session_service.proto\x12\x12tensorflow.serving\x1a\x32stfsclient/tensorflow_serving/internal/model.proto\x1a\"stfsclient/tensorflow/config.proto\x1a(stfsclient/tensorflow/named_tensor.proto\"\xba\x01\n\x11SessionRunRequest\x12\x31\n\nmodel_spec\x18\x01 \x01(\x0b\x32\x1d.tensorflow.serving.ModelSpec\x12*\n\x04\x66\x65\x65\x64\x18\x02 \x03(\x0b\x32\x1c.tensorflow.NamedTensorProto\x12\r\n\x05\x66\x65tch\x18\x03 \x03(\t\x12\x0e\n\x06target\x18\x04 \x03(\t\x12\'\n\x07options\x18\x05 \x01(\x0b\x32\x16.tensorflow.RunOptions\"\xa0\x01\n\x12SessionRunResponse\x12\x31\n\nmodel_spec\x18\x03 \x01(\x0b\x32\x1d.tensorflow.serving.ModelSpec\x12,\n\x06tensor\x18\x01 \x03(\x0b\x32\x1c.tensorflow.NamedTensorProto\x12)\n\x08metadata\x18\x02 \x01(\x0b\x32\x17.tensorflow.RunMetadata2m\n\x0eSessionService\x12[\n\nSessionRun\x12%.tensorflow.serving.SessionRunRequest\x1a&.tensorflow.serving.SessionRunResponseB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[stfsclient_dot_tensorflow__serving_dot_internal_dot_model__pb2.DESCRIPTOR,stfsclient_dot_tensorflow_dot_config__pb2.DESCRIPTOR,stfsclient_dot_tensorflow_dot_named__tensor__pb2.DESCRIPTOR,])
...
_SESSIONRUNREQUEST.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_model__pb2._MODELSPEC
_SESSIONRUNREQUEST.fields_by_name['feed'].message_type = stfsclient_dot_tensorflow_dot_named__tensor__pb2._NAMEDTENSORPROTO
_SESSIONRUNREQUEST.fields_by_name['options'].message_type = stfsclient_dot_tensorflow_dot_config__pb2._RUNOPTIONS
_SESSIONRUNRESPONSE.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_internal_dot_model__pb2._MODELSPEC
_SESSIONRUNRESPONSE.fields_by_name['tensor'].message_type = stfsclient_dot_tensorflow_dot_named__tensor__pb2._NAMEDTENSORPROTO
_SESSIONRUNRESPONSE.fields_by_name['metadata'].message_type = stfsclient_dot_tensorflow_dot_config__pb2._RUNMETADATA
...
SessionRunRequest = _reflection.GeneratedProtocolMessageType('SessionRunRequest', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.internal.session_service_pb2'
