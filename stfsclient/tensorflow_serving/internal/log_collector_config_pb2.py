...
# source: stfsclient/tensorflow_serving/internal/log_collector_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow_serving/internal/log_collector_config.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\nAstfsclient/tensorflow_serving/internal/log_collector_config.proto\x12\x12tensorflow.serving\";\n\x12LogCollectorConfig\x12\x0c\n\x04type\x18\x01 \x01(\t\x12\x17\n\x0f\x66ilename_prefix\x18\x02 \x01(\tB\x03\xf8\x01\x01\x62\x06proto3')
)
...
LogCollectorConfig = _reflection.GeneratedProtocolMessageType('LogCollectorConfig', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.internal.log_collector_config_pb2'
