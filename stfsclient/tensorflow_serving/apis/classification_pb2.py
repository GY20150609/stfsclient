...
# source: stfsclient/tensorflow_serving/apis/classification.proto
...
_CLASSIFICATIONREQUEST.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_apis_dot_model__pb2._MODELSPEC
_CLASSIFICATIONREQUEST.fields_by_name['input'].message_type = stfsclient_dot_tensorflow__serving_dot_apis_dot_input__pb2._INPUT
_CLASSIFICATIONRESPONSE.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_apis_dot_model__pb2._MODELSPEC
...
Class = _reflection.GeneratedProtocolMessageType('Class', (_message.Message,), {
  'DESCRIPTOR' : _CLASS,
  '__module__' : 'stfsclient.tensorflow_serving.apis.classification_pb2'
