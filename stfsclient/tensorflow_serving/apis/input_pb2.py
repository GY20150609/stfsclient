...
# source: stfsclient/tensorflow_serving/apis/input.proto
...
_EXAMPLELIST.fields_by_name['examples'].message_type = stfsclient_dot_tensorflow_dot_core_dot_example_dot_example__pb2._EXAMPLE
_EXAMPLELISTWITHCONTEXT.fields_by_name['examples'].message_type = stfsclient_dot_tensorflow_dot_core_dot_example_dot_example__pb2._EXAMPLE
_EXAMPLELISTWITHCONTEXT.fields_by_name['context'].message_type = stfsclient_dot_tensorflow_dot_core_dot_example_dot_example__pb2._EXAMPLE
...
ExampleList = _reflection.GeneratedProtocolMessageType('ExampleList', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.apis.input_pb2'
