...
# source: stfsclient/tensorflow_serving/config/model_server_config.proto
...
_MODELCONFIG.fields_by_name['model_version_policy'].message_type = stfsclient_dot_tensorflow__serving_dot_sources_dot_storage__path_dot_file__system__storage__path__source__pb2._FILESYSTEMSTORAGEPATHSOURCECONFIG_SERVABLEVERSIONPOLICY
_MODELCONFIG.fields_by_name['version_labels'].message_type = _MODELCONFIG_VERSIONLABELSENTRY
_MODELCONFIG.fields_by_name['logging_config'].message_type = stfsclient_dot_tensorflow__serving_dot_config_dot_logging__config__pb2._LOGGINGCONFIG
...
_MODELSERVERCONFIG.fields_by_name['custom_model_config'].message_type = stfsclient_dot_google_dot_protobuf_dot_any__pb2._ANY
...
ModelConfig = _reflection.GeneratedProtocolMessageType('ModelConfig', (_message.Message,), {
  ...
  'VersionLabelsEntry' : _reflection.GeneratedProtocolMessageType('VersionLabelsEntry', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow_serving.config.model_server_config_pb2'
