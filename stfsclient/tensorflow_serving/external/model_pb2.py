...
# source: stfsclient/tensorflow_serving/external/model.proto
...
ModelSpec = _reflection.GeneratedProtocolMessageType('ModelSpec', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.model_pb2'
