...
# source: stfsclient/tensorflow_serving/external/input.proto
...
ExampleList = _reflection.GeneratedProtocolMessageType('ExampleList', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.input_pb2'
