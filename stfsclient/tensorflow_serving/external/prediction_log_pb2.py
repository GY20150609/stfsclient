...
# source: stfsclient/tensorflow_serving/external/prediction_log.proto
...
_CLASSIFYLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_classification__pb2._CLASSIFICATIONREQUEST
_CLASSIFYLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_classification__pb2._CLASSIFICATIONRESPONSE
_REGRESSLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_regression__pb2._REGRESSIONREQUEST
_REGRESSLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_regression__pb2._REGRESSIONRESPONSE
_PREDICTLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_predict__pb2._PREDICTREQUEST
_PREDICTLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_predict__pb2._PREDICTRESPONSE
_MULTIINFERENCELOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_inference__pb2._MULTIINFERENCEREQUEST
_MULTIINFERENCELOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_inference__pb2._MULTIINFERENCERESPONSE
_SESSIONRUNLOG.fields_by_name['request'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_session__service__pb2._SESSIONRUNREQUEST
_SESSIONRUNLOG.fields_by_name['response'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_session__service__pb2._SESSIONRUNRESPONSE
_PREDICTIONLOG.fields_by_name['log_metadata'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_logging__pb2._LOGMETADATA
...
ClassifyLog = _reflection.GeneratedProtocolMessageType('ClassifyLog', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.prediction_log_pb2'
