...
# source: stfsclient/tensorflow_serving/external/inference.proto
...
from stfsclient.tensorflow_serving.external import input_pb2 as stfsclient_dot_tensorflow__serving_dot_external_dot_input__pb2
from stfsclient.tensorflow_serving.external import model_pb2 as stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2
...
_INFERENCETASK.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
_INFERENCERESULT.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
_INFERENCERESULT.fields_by_name['classification_result'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_classification__pb2._CLASSIFICATIONRESULT
_INFERENCERESULT.fields_by_name['regression_result'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_regression__pb2._REGRESSIONRESULT
...
_MULTIINFERENCEREQUEST.fields_by_name['input'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_input__pb2._INPUT
...
InferenceTask = _reflection.GeneratedProtocolMessageType('InferenceTask', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.inference_pb2'
