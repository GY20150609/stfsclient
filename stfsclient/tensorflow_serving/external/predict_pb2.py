...
# source: stfsclient/tensorflow_serving/external/predict.proto
...
_PREDICTREQUEST.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
...
_PREDICTRESPONSE.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
...
PredictRequest = _reflection.GeneratedProtocolMessageType('PredictRequest', (_message.Message,), {
  ...
  'InputsEntry' : _reflection.GeneratedProtocolMessageType('InputsEntry', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow_serving.external.predict_pb2'
