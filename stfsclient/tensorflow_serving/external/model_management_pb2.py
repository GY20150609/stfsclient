...
# source: stfsclient/tensorflow_serving/external/model_management.proto
...
from stfsclient.tensorflow_serving.external import model_server_config_pb2 as stfsclient_dot_tensorflow__serving_dot_external_dot_model__server__config__pb2
from stfsclient.tensorflow_serving.external import status_pb2 as stfsclient_dot_tensorflow__serving_dot_external_dot_status__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow_serving/external/model_management.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n=stfsclient/tensorflow_serving/external/model_management.proto\x12\x12tensorflow.serving\x1a@stfsclient/tensorflow_serving/external/model_server_config.proto\x1a\x33stfsclient/tensorflow_serving/external/status.proto\"L\n\x13ReloadConfigRequest\x12\x35\n\x06\x63onfig\x18\x01 \x01(\x0b\x32%.tensorflow.serving.ModelServerConfig\"G\n\x14ReloadConfigResponse\x12/\n\x06status\x18\x01 \x01(\x0b\x32\x1f.tensorflow.serving.StatusProtoB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[stfsclient_dot_tensorflow__serving_dot_external_dot_model__server__config__pb2.DESCRIPTOR,stfsclient_dot_tensorflow__serving_dot_external_dot_status__pb2.DESCRIPTOR,])
...
_RELOADCONFIGREQUEST.fields_by_name['config'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__server__config__pb2._MODELSERVERCONFIG
_RELOADCONFIGRESPONSE.fields_by_name['status'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_status__pb2._STATUSPROTO
...
ReloadConfigRequest = _reflection.GeneratedProtocolMessageType('ReloadConfigRequest', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.model_management_pb2'
