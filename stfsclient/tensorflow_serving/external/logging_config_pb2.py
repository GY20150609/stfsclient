...
# source: stfsclient/tensorflow_serving/external/logging_config.proto
...
from stfsclient.tensorflow_serving.external import log_collector_config_pb2 as stfsclient_dot_tensorflow__serving_dot_external_dot_log__collector__config__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='stfsclient/tensorflow_serving/external/logging_config.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n;stfsclient/tensorflow_serving/external/logging_config.proto\x12\x12tensorflow.serving\x1a\x41stfsclient/tensorflow_serving/external/log_collector_config.proto\"\'\n\x0eSamplingConfig\x12\x15\n\rsampling_rate\x18\x01 \x01(\x01\"\x92\x01\n\rLoggingConfig\x12\x44\n\x14log_collector_config\x18\x01 \x01(\x0b\x32&.tensorflow.serving.LogCollectorConfig\x12;\n\x0fsampling_config\x18\x02 \x01(\x0b\x32\".tensorflow.serving.SamplingConfigB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[stfsclient_dot_tensorflow__serving_dot_external_dot_log__collector__config__pb2.DESCRIPTOR,])
...
_LOGGINGCONFIG.fields_by_name['log_collector_config'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_log__collector__config__pb2._LOGCOLLECTORCONFIG
...
SamplingConfig = _reflection.GeneratedProtocolMessageType('SamplingConfig', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.logging_config_pb2'
