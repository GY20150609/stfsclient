...
# source: stfsclient/tensorflow_serving/external/model_server_config.proto
...
_MODELCONFIG.fields_by_name['model_version_policy'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_file__system__storage__path__source__pb2._FILESYSTEMSTORAGEPATHSOURCECONFIG_SERVABLEVERSIONPOLICY
_MODELCONFIG.fields_by_name['version_labels'].message_type = _MODELCONFIG_VERSIONLABELSENTRY
_MODELCONFIG.fields_by_name['logging_config'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_logging__config__pb2._LOGGINGCONFIG
...
ModelConfig = _reflection.GeneratedProtocolMessageType('ModelConfig', (_message.Message,), {
  ...
  'VersionLabelsEntry' : _reflection.GeneratedProtocolMessageType('VersionLabelsEntry', (_message.Message,), {
    ...
    '__module__' : 'stfsclient.tensorflow_serving.external.model_server_config_pb2'
