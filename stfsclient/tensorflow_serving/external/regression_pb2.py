...
# source: stfsclient/tensorflow_serving/external/regression.proto
...
_REGRESSIONREQUEST.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
_REGRESSIONREQUEST.fields_by_name['input'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_input__pb2._INPUT
_REGRESSIONRESPONSE.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
...
Regression = _reflection.GeneratedProtocolMessageType('Regression', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.regression_pb2'
