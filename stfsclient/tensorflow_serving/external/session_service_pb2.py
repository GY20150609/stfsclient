...
# source: stfsclient/tensorflow_serving/external/session_service.proto
...
_SESSIONRUNREQUEST.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
...
_SESSIONRUNRESPONSE.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
...
SessionRunRequest = _reflection.GeneratedProtocolMessageType('SessionRunRequest', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.session_service_pb2'
