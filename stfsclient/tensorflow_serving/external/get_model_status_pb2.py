...
# source: stfsclient/tensorflow_serving/external/get_model_status.proto
...
_GETMODELSTATUSREQUEST.fields_by_name['model_spec'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_model__pb2._MODELSPEC
_MODELVERSIONSTATUS.fields_by_name['state'].enum_type = _MODELVERSIONSTATUS_STATE
_MODELVERSIONSTATUS.fields_by_name['status'].message_type = stfsclient_dot_tensorflow__serving_dot_external_dot_status__pb2._STATUSPROTO
...
GetModelStatusRequest = _reflection.GeneratedProtocolMessageType('GetModelStatusRequest', (_message.Message,), {
  ...
  '__module__' : 'stfsclient.tensorflow_serving.external.get_model_status_pb2'
