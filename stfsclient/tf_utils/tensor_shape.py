"""
Helper script for tensor shape inference, adapted from TensorFlow library.
Link: https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/framework/tensor_shape.py
"""

from stfsclient.tensorflow import tensor_shape_pb2
