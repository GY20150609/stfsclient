"""
Helper script for manipulating tensor dtypes, adapted from TensorFlow library.
Link: https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/framework/dtypes.py
"""

import numpy as np
from six.moves import builtins

from stfsclient.tensorflow import types_pb2

# (jagans94):  All _np_bfloat16 uses has been commented out, as I 
